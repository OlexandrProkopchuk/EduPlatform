...
namespace EduPlatformSolution.Controllers
{
    public class Questions1Controller : Controller
    {
        ...
        public Questions1Controller(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,QuizId,Text,Type")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuizId,Text,Type")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
